...
type RollingFileAppender struct {
	// This embeds the `BaseAppender` type
...
type rollingFileAppenderBuilder struct {
	...
	headerGenerator      func() []string
	stringWriterCallback func(*os.File) slogger.StringWriter
	minAllowedLogLevel slogger.Level
}
...
func (b *rollingFileAppenderBuilder) WithMinAllowedLogLevel(minAllowedLogLevel slogger.Level) *rollingFileAppenderBuilder {
	b.minAllowedLogLevel = minAllowedLogLevel
	return b
}
...
func (b *rollingFileAppenderBuilder) Build() (*RollingFileAppender, error) {
	...
	appender.SetLevel(b.minAllowedLogLevel)
